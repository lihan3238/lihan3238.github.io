...
- 重做了    update(更新计划)界面，重命名为[计划与博客更新日志](https://lihan3238.github.io/计划与博客更新日志/)

- 重启了    tips(随笔)页面，使用密码阻止不熟的人访问部分内容: [随笔](https://lihan3238.github.io/随笔/)

- 弃用了    gitalk作为`随笔`页面的实现形式，改为文章链接

- 待更新    补充博客更新日志，呜呜呜，gitcommit记录中考古吧
